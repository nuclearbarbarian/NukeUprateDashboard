      ...
      <header style={{background:C.ink,color:C.paper,padding:"24px 36px",display:"flex",alignItems:"center"}}>
        ...
        <div style={{flex:1,display:"flex",justifyContent:"flex-end"}}>
          <div className="logo-tip" style={{display:"inline-block",position:"relative",cursor:"pointer"}}>
            ...
            <div className="logo-tooltip" style={{display:"none",position:"absolute",top:"calc(100% + 8px)",right:0,width:300,background:C.paper,color:C.ink,border:`2px solid ${C.g30}`,padding:"12px 14px",zIndex:100,fontSize:12,lineHeight:1.6,fontFamily:serif,textAlign:"left",boxShadow:"0 2px 8px rgba(0,0,0,0.3)"}}>
