            ...
            {sel?(()=>{
              ...
              return(<div style={{padding:20}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8}}>
                  {[
                    {l:"Reactor Type",v:sel.type,hdr:"Reactor Type",tip:"PWRs (Pressurized Water Reactors) keep coolant under high pressure to prevent boiling; heat transfers to a secondary steam loop via steam generators. BWRs (Boiling Water Reactors) boil water directly in the reactor vessel to drive the turbine. The majority of the U.S. commercial fleet is PWR."},
                    {l:"NSSS Design",v:sel.lp,hdr:"Nuclear Steam Supply System",tip:"The core reactor design from the original vendor — a key factor in uprate feasibility and available engineering support. Common designators: Westinghouse (W), GE (now GE-Hitachi), Combustion Engineering (CE, now Framatome), and Babcock & Wilcox (B&W, now BWX Technologies). These are historical design lineages; current licensing and engineering support flows through the successor entities."},
                    {l:"Market",v:sel.mkt,hdr:"Market Structure",tip:"Regulated plants operate under cost-of-service rate cases — utilities recover uprate costs through rate increases approved by state PUCs. Merchant plants sell power at market prices; uprate returns depend on capacity revenues and energy market conditions."},
                    {l:"Max Uprate Cap",v:`${(sel.cap*100).toFixed(0)}%`,hdr:"Maximum Uprate Cap",tip:"The maximum thermal power uprate recorded or projected for this reactor, based on plant-specific NRC analysis. Extended Power Uprates (EPUs) can approach the physical and licensing limits of the plant. Measurement Uncertainty Recapture (MUR) uprates are typically 1–2% and require a formal license amendment, though with less supporting analysis than an EPU."},
                    {l:"State SEPA",v:sd?.sepa?"Yes":"No",hdr:"State Environmental Policy Act",tip:"A state-level environmental review law analogous to federal NEPA. State SEPAs do not govern NRC license amendments, which are a federal process. However, uprate projects may involve state-permitted ancillary work — transmission, water permits, site construction — where a SEPA review could apply. Applicability varies by state."},
